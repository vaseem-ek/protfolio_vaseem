...
const containeVarients = {
    hidden: { opacity: 0, x: -100 },
    visible: {
        opacity: 1, x: 0, transition: {
            duration: 0.5, staggerChildren: 0.5
        }
    }
}
            ...
            <div className='flex flex-wrap lg:flex-row-reverse'>
                ...
                <div className='w-full lg:w-1/2' >
                    ...
                    className='flex flex-col items-center  lg:items-start mt-10'>
                        ...
                        <motion.a
                        variants={childVariets} href="/resume.pdf" target='-blank' rel='noopener noreferrer' download className='bg-white rounded-full p-4  text-sm text-stone-800 mb-10'>Download Resume</motion.a>
                    </motion.div>
                </div>
            </div>
        </div>
